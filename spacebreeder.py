...
#========== PARAMETER INPUT
corpus_file  = "SET/THIS/PATH/ukwac_100m_linewise.txt" #TODO set the correct path
w2v_exe_file = "./../word2vec/share/word2vec" #TODO set the correct path to the word2vec executive code

testset_file         = "pipe/testset_MEN_pairs"
results_summary_file = "pipe/summary.tsv"

matrix_filename    = "pipe/ffa/cooc"
fly_location       = "pipe/ffa/configs/"
space_location     = "pipe/ffa/spaces/"
results_location   = "pipe/ffa/results/stats/"
vip_words_location = "pipe/ffa/results/words/"

w2v_corpus_file    = "pipe/w2v/ressouce.txt"
w2v_space_location = "pipe/w2v/spaces/" 
w2v_results_file   = "pipe/w2v/results.txt"
