...
if len(sys.argv) < 5 or sys.argv[1] not in ("bnc","wiki","rawiki","w2v","1k","5k","10k"):
    print("\nUSAGE: python3 projection.py bnc|wiki|rawiki|w2v|1k|5k|10k [num-kc] [size-proj] [percent-hash]\n\
